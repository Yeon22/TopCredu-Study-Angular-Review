...
export class ChildComponent
  ...
  // 부모 컴포넌트의 설정 <app-child [prop]="shouldShow" ... >
  // prop 이라는 키 값을 변수명이나 접근제어 프로퍼티명으로 맞추어 주면
  // 파라미터를 받을 수 있다.
  // 파라미터를 받는 순간에 로직을 밀어 넣고 싶을 때 set 같은 것을 사용
  @Input()
  ...
  ngOnChanges(changes) { // 조건기동
    // 외부로부터 상태(파라미터)를 전달받을 때에만 매번 호출된다.
